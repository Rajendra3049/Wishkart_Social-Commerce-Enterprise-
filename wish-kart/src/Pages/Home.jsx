...
const Home = () => {
  return (
    ...
    <Heading fontSize={["25px","30px","46px"]} lineHeight={"56px"} color={"#333333"} fontWeight={650} textAlign={"left"}>Lowest Prices </Heading>
    <Heading fontSize={["25px","30px","46px"]}lineHeight={"56px"} color={"#333333"} fontWeight={650} mt={["-24px","2px","5px"]} textAlign={"left"}> Best Quality Shopping </Heading>
   
   <Box >
   <Flex>
    <Box backgroundColor={"#f7a8ca"} borderRadius={"50%"} w={"38px"} h={"38px"} mt={"27px"} p={1} >
      <Flex>
    <Text fontSize={"30px"} ml={"4px"}><CiDeliveryTruck bg={"#f7a8ca"} mt={"15px"}/></Text>
    <Text fontWeight={400} ml={"17px"} fontSize={"14px"} mt={"-5px"}>Free Delievery</Text>
   ...
   <Box mt={"34px"}>
    ...
    <Button w={"312px"} h={"48px"} bg={"#f43397"} color={'white'} _hover={"#f43397"} fontSize={18} fontWeight={550}> <Image src={playstore} w={12} h={12} /> Download the WishKart App</Button>
    </Flex>
   </Box>
    ...
    <Image src="https://images.meesho.com/images/marketing/1631722939962.webp"/>
     ...
     <Box mt={"30px"}>
     <Flex>
     <Divider orientation="horizontal" width={"21%"} height={"1px"} bg={"rgb(247, 168, 202)"} mt={"70px"}ml={["10px","10px","100px"]}/>
     <Heading fontSize={["15px","20px","36px"]} lineHeight={"44px"} color={"#333333"} mt={["50px","50px","40px"]} ml={["6px","","15px"]}>Top Categories to choose from</Heading>
     <Divider orientation="horizontal" width={"21%"} height={"1px"} bg={"rgb(247, 168, 202)"} mt={["71px","70px","70px"]} ml={["4px","10px","70px"]}/>
     </Flex>
     </Box>
    ...
    <Flex gap={5}>
      ...
      <Box border={"1px solid red"} w={"30%"} h={"600px"}></Box>
      <Box w={"70%"} border={"1px solid blue"}><HomeProducts/></Box>

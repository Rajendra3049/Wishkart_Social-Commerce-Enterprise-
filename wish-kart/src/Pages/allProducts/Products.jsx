...
const Products = () => {
  ...
  let filtData = data.filter(
    (el) =>
      (filtCred.above100 ? el.original_price > 1000 : "") ||
      (filtCred.a1000_500
        ? el.original_price < 1000 && el.original_price > 500
        : "") ||
      (filtCred.a500_300
        ? el.original_price < 500 && el.original_price > 300
        : "") ||
      ...
      <Flex>
        <Box width={"20%"}>
          ...
          <Stack direction={"column"} ml="5%">
            <Checkbox onChange={(e) => check(e)} name="above100">
              Above 1000
            </Checkbox>
            <Checkbox onChange={(e) => check(e)} name="a1000_500">
              1000 - 500
            </Checkbox>
            <Checkbox onChange={(e) => check(e)} name="a500_300">
              500 - 300
            </Checkbox>
            <Checkbox onChange={(e) => check(e)} name="below300">
              Below 300
            </Checkbox>
          </Stack>
        </Box>

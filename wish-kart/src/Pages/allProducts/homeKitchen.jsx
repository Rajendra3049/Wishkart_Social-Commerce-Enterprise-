...
//   console.log(data)
  ...
  let filtData = homeKitchen.filter((el)=> ((filtCred.above100? el.discounted_price>1000:"") || 
...
if(loading){
  ...
  return (
    <Box  mt={"150px"}>
          ...
          <Menu>
            ...
            <MenuList>
              ...
              <MenuOptionGroup title="Category">
                ...
                <ChakraCheckBox onChange={(e) => check(e)} name="ratingTop" size={"lg"}>Above 4.5</ChakraCheckBox>
                    <ChakraCheckBox onChange={(e) => check(e)} name="ratingTop2" size={"lg"} >4.5 - 4</ChakraCheckBox>
                    <ChakraCheckBox onChange={(e) => check(e)} name="a4_3" size={"lg"}>4 - 3</ChakraCheckBox>
                    <ChakraCheckBox onChange={(e) => check(e)} name="a3-2" size={"lg"} >3 - 2</ChakraCheckBox>
                    <ChakraCheckBox onChange={(e) => check(e)} name="below2" size={"lg"} >below 2</ChakraCheckBox>
      ...
      <Hide below="md"  >
      <Box width={"20%"}>
      <Heading color={"#f43397"} marginLeft="7%">Filter</Heading>
          <Box>
            <Accordion>
              ...
              <AccordionItem>
                <AccordionButton>
                  <Box as="span" flex='1' fontSize={20} textAlign='left'ml={"5%"}> Price</Box>
                </AccordionButton>
                {/* <AccordionPanel> */}
                <Stack  direction={"column"} ml="15%">
              ...
              <AccordionItem>
                  ...
                  <Stack direction={"column"} ml="15%">
                    ...
                    <Checkbox onChange={(e) => check(e)} name="ratingTop" size={"lg"}>Above 4.5</Checkbox>
                    <Checkbox onChange={(e) => check(e)} name="ratingTop2" size={"lg"} >4.5 - 4</Checkbox>
                    <Checkbox onChange={(e) => check(e)} name="a4_3" size={"lg"}>4 - 3</Checkbox>
                    <Checkbox onChange={(e) => check(e)} name="a3-2" size={"lg"} >3 - 2</Checkbox>
                    <Checkbox onChange={(e) => check(e)} name="below2" size={"lg"} >below 2</Checkbox>
      ...
      <Box style={{width:"90%",margin:"auto"}} border="0px solid red">
        ...
        <SimpleGrid columns={[1, 2, 3, 4]} spacing={10}  >
          {(filtData.length==0? homeKitchen:filtData).map((el) => {

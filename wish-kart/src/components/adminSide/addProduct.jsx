...
import { addNewProduct } from "../../redux/admin/admin.action";
import { useDispatch, useSelector } from "react-redux";
import { AddProductNotify } from "../notify";
...
export default function AddNewProduct({ setShowPage }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    dispatch(addNewProduct({ token, state }))
      .then(window.alert("Product added successfully"))
      .then(setShowPage("Products"));
  }
      ...
      <div className={styles.root}>
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.row}>
            ...
            <input type="submit" className={styles.btn} value={"Add Product"}>
              {/* <AddProductNotify /> */}
            </input>
          </div>
        </form>

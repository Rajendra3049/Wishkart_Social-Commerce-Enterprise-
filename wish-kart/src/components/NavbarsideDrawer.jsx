...
import { Popover,Text,Image,Box , PopoverTrigger,Button, PopoverContent, PopoverArrow, PopoverCloseButton, PopoverHeader, PopoverBody, Flex } from '@chakra-ui/react'
  ...
  <PopoverContent>
    ...
    <PopoverBody >
        ...
        <Popover trigger={"hover"} placement='left'>
            ...
            <hr />
            <br />
            <Box onClick={adminhandlepanel} display={'flex'} cursor="pointer" alignItem={"center"} gap={"5px"} >
                <EditIcon fontSize={'16px'}/>
              <Text _hover={{color:'pink.400'}}  fontSize={["9px", "8x", "15px"]}>Admin</Text>
            </Box>
            {/* ------------------profile---------------- */}
            <br />
            <hr />
            <br />
            <Box display={'flex'} cursor="pointer" alignItem={"center"} gap={"5px"}>
              
            <BiUser fontSize={'16px'}/>  <Popover trigger="hover">
                <PopoverTrigger>
                  <Text fontSize={{ bse: "5px", md: "8px", lg: "38px" }} _hover={{color:'pink.400'}}>
                    Profile
                  </Text>
                </PopoverTrigger>
                <PopoverContent>
            ...
            <hr />
            <br />
            <Box display={'flex'} align='center' gap='5px' onClick={carthandlepageF}>
            <BsCart2 fontSize={'16px'}/>
            <Text _hover={{color:'pink.400'}}   fontSize={["9px", "8x", "15px"]}>Cart</Text>
            </Box>

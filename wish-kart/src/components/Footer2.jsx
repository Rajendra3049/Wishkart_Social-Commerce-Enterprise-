        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={2}>
            ...
            <Text
              ...
              mt={"18px"}>
              When it comes to{" "}
              <b style={{ color: "#f43397" }}>women's ethnic wear</b>, we have
              everything you need to find the perfect outfit for any occasion.
              Whether you're looking for traditional sarees and blouses, or
              something more modern like suits or casual{" "}
              <b style={{ color: "#f43397" }}>Kurtis</b>, we have it all. And
              with our stunning collection of accessories, footwear, and{" "}
              <b style={{ color: "#f43397" }}>jewellery sets</b>, it's easy to
              put together a complete look that will turn heads at your next
              wedding or festive celebration. So come and shop with us today!
            </Text>
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"18px"}>
              Do you need a new Sherwani? Are you heading to a wedding and want
              to look your best? If you answered yes, look no further than our
              latest men's ethnic wear collection! Whether you want a Kurta set,
              Pajamas, Sherwani set, or any other Indian attire, we have an
              array of budget-friendly styles that are sure to fit your needs.
            </Text>
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"18px"}>
              Through our large selection of menswear products we offer, you're
              sure to find something you love. We have a vast collection of
              t-shirts, jeans, polos, coats, and shirts. We have sizes in stock
              that fit any man's body type, and the best news of all is that
              they're all affordable. We make it easy to find exactly what
              you're looking for, too. Our search tool lets you filter our
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"18px"}>
              If you're on the hunt for a new sherwani or any other type of
              Indian attire for an upcoming wedding, our latest men's ethnic
              wear collection has got you covered. We have a range of
              budget-friendly styles to choose from, so you're sure to find
              something that fits your needs. Whether you're looking for a
              Sherwani set, Kurta pajamas, or an ethnic jacket, we've got it
              all!
            </Text>
            ...
            <Text
              ...
              upper hand in style better than us. Shop our online collection of
              accessories for men and pick out something for yourself or for
              your other half! Our accessories collection includes items like
              men's wallets, cufflinks, bags for men, and more. So don't waste
              another minute and get yourself some accessories today! Do not
              forget to check out our latest footwear for men. We have
              everything from colorful sneakers to formal footwear to flip-flops
              for men.
            </Text>
            ...
            <Text
              ...
              only stock up on the best{" "}
              <b style={{ color: "#f43397" }}>makeup</b> and skincare that won't
              damage your skin or make you break out. We have everything from
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"18px"}>
              Kids grow so fast, it feels like you're constantly buying new
              clothes for them! Whether you're looking for the latest trends or
              just want something practical and affordable, our kidswear
              collection has got you covered. You'll find everything from
              rompers and dresses for girls to sets and jeans for boys. Plus, we
              have ethnic wear and accessories for kids of all ages. And don't
              forget to check out our baby care collection for all the basic
              products for <b style={{ color: "#f43397" }}>baby care</b>.
            </Text>
            <Heading
              color={"#333333"}
              fontWeight={700}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"18px"}>
              If you're looking to spice up your kitchen, then you've come to
              the right place! We carry a wide variety of home and kitchen
              ...
              reasonable price. We're confident that we have everything you're
              looking for in your kitchen or home!
            </Text>
            ...
            <Text
              ...
              top of the latest trends. So be sure to check out our home decor
              section today!
            </Text>
            <Heading
              color={"#333333"}
            ...
            <Text
              ...
              discounts on products, allowing you to save on your favorite
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"18px"}>
              We have a wide range of stationery items which will help you stay
              tidy and organised. You can buy notebooks, diaries and notepads
              and craft supplies which are great for school and college, or you
              can buy office supplies which are great for adults. We have a
              variety of pens, pencils, and other stationery supplies to ensure
              that you have what you need to write down your thoughts, make
            ...
            <Text
              ...
              plethora of products and even get great deals with more discounts
              than you can count. You can even share products you like with your
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Curtains & Sheers | Round Cushions | Sofa Covers | Cotton
              Bedsheets | Bedding Sets | Pillow Covers | Decorative Items |
              Duvet Covers | Blankets | Home Temple | Yoga mats | Bean Bags |
              Single Bed Sheet | Cushions | Face Towels | Cotton Towel | Trays |
              Coasters
            </Text>
            <Heading
              fontWeight={500}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Men Dhoti Kurtas | Men Indo Western Dresses | Men Velvet Sherwanis
              | Men Dhotis
            </Text>
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Women Frocks | Long Tops Women | Tshirt Dresses | Designer Gown |
              Pencil Skirts | Women Trousers | Flared Jeans | Women Sweatshirts
              | Shrugs | Capris | Jacket Dresses | Fancy Ladies Sweater |
              Chikankari Palazzos | Ankle Length Leggings | Tights | Printed
              Leggings | Kaftans | Maternity Wear | Denim Women Shorts | Black
              Jeggings | Short Night Dress | Women Night Suits | Lace Lingerie
              Sets | Lingerie Sets | Push Up Bra | Stockings | Black Camisoles |
              Cotton Bathrobes | Satin Night Suit | Body shapers | Women Pyjamas
              | Swimwear | Women Jackets | Women Thermal Set
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Silk Saree | Puff Sleeve Blouses | Chikankari Kurtis | Designer
              Lehenga | Sharara | Phulkari Dupatta | Petticoats | Abaya | Black
              Kurta | Velvet Shawls | Blouse Piece | Kurti Fabric | Designer
              Suits
            </Text>
            <Heading
              fontWeight={500}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Hoop Earrings | Stud Earrings Women | Oxidised Ring | Handbags |
              Umbrellas | Cateye Sunglasses | Jewellery Set | Slingbags |
              Trolley Bags | Hijabs | Ankle Socks Women | Clutches | Hair
              Accessories | Maangtika | Pouches | Duffle Bags | Pashmina Shawls
              | Bindis | Waist Bags | Rucksacks | Briefcases | Small Travel Bags
              | Potlis | Nosepins | Gold Bangles | Bridal Anklets | Chandbali
              Earrings | Necklaces | Multi Necklace
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Android Smart Watches | On Ear Headphones | Bluetooth Speakers |
              Bluetooth Earphones | Sport Headphones | CCTV Cameras | Spy
              Cameras | Keyboard | Laptop Bags | Mouse | Laptop Accessories |
              Pen Drives | Earphones | Fast Charging Power Banks | Headphones |
              Data Cables | Car Mobile Holders | Car Mobile Holders | Mobile
              Chargers | Speakers | Diwali Lightings | Microphone | Memory Cards
              | Digital Photo Frames | Dongle | VR Box
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Cotton Shorts Men | Denim Jeans Men | Formal Trousers Men | Men
              Active Shorts | Sport Jackets Men | Printed Tshirts | Formal
              Shirts Men | Sleeveless Sweatshirts Men | Leather Jackets Men |
              Grey Blazers | Men Sweaters | Sport Tracksuits Men | Vests |
              Printed Briefs Men | Men Trunks | Wool Jackets Men
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Leather Watches Men | Gold Jewellery Men | Hair Spray For Men |
              Men Keychains | Men Socks | Men Scarves | Men Wrist Bands | Men
              Crossbody Bags | Men Shirt Studs
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Kids Lunch Boxes | Kids Ethnic Jackets | Kids Blazers | Rompers |
              Kids Kurtis & Kurtas | Kids Salwar Suit Sets | Kids Ethnic Gowns |
              Tshirts Boys | Girls Stylish Tops
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Baby Pillows | Baby Towels | Baby Hanging Cradle | Baby Sleeping
              Bag | Baby Blanket
            </Text>
            <Heading
              fontWeight={500}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Toaster | Mixer Grinder | Cookers | Juicer | Food Processors |
              Roti Maker | Sandwich Maker | Kettles | Hand Blender | Table Cover
              | Napkins Holder | Kitchen Mat | Kitchen Towel | Aprons | Kitchen
              Gloves | Racks & Holders | Spice Racks | Jars & Container | Water
              Bottles | Thermos & Flasks | Lunch Boxes | Salt & Pepper Shakers |
              Knives | Food Strainers | Choppers | Mashers | Graters | Cutlery |
              Chopping Boards | Kitchen Scissors | Ice Cube Trays | Measuring
              Cups | Tongs | Ice Cream Scoops | Funnels | Trivets
            </Text>
            <Heading
              fontWeight={500}
              color={"#333333"}
            ...
            <Text
              ...
              fontSize={["10px", "12px", "14px"]}
              mt={"8px"}>
              Tummy trimmer | Makeup Kits | Hair Color | Hair Steamers | Hair
              Care | Oral Care | Beard Oil | Deodorants | Eye Lenses | Soap |
              Oximeter | Bb Cream | Body Scrub | Olive Oils | Talcum Powder |
              Face Steamers | Compact | Nail Cutter | Lip Balm
            </Text>
          </AccordionPanel>
        </AccordionItem>
      </Accordion>

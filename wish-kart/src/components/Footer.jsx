...
<SimpleGrid columns={{ base:1, sm: 3, md:4 , lg: 5 }} spacing={6}>
<Stack width={["700px","650px","400px"]} ml={"5px"} >
    <Flex>
<Heading color={"#333333"} fontSize={'5xl'} lineHeight={"24px"} ml={["90px","0px","15px"]} mt={"20px"}>Shop Non-Stop on Meesho</Heading>
</Flex>
<Stack mt={"40px"} paddingLeft={["90px","0px","15px"]}>
...
<Text color={"#333333"} fontWeight={600} fontSize={["14px","14px","16px"]} mt={2} >Cash on Delivery | Free Delivery</Text>
 ...
 <Box>
  <Flex ml={["90px","0px","5px"]}>
 <Image src={google}  w={["140px","145px","200px"]} mt={'10px'} h={"80px"}/>
<Image src={Appstore}  w={["140px","145px","200px"]} h={"88px"} mt={"0px"} />
</Flex>
 </Box>
</Stack>
<Stack align={'flex-start'} ml={["110px","140px","200px"]} w={"60%"}>
<Text color={"#8d8d8d"} fontWeight={600} fontSize={["14px","14px","16px"]} mt={["0px","27px","20px"]}>Careers</Text>
...
<Stack align={'flex-start'}  ml={["280px","100px","110px"]}  w={"60%"} mt={["-82px","-80px","0px"]}>
<Text color={"#8d8d8d"}  fontWeight={600} fontSize={["14px","14px","16px"]}  mt={["0px","105px","20px"]}>Legal and Policies</Text>
...
<Heading color={"#333333"} fontSize={"20px"} lineHeight={"24px"}  ml={["110px","20px","25px"]}>Reach out to us</Heading>
<Box>
<Flex  ml={["110px","15px","25px"]} >
...
<Stack align={'flex-start'} ml={["110px","20px","8px","-40px"]} w={["350px","550px","300px"]}  mt={["0px","0px","15px"]} >
